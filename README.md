...
ダウンロード: https://github.com/miyako/4d-component-geo-jp-a/releases/download/1.0.0/geo.4dbase.zip

**市区町村レベル**のデータベースは[こちら](https://github.com/miyako/4d-component-geo-jp-b)にあります。
